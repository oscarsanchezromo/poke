...
class homePages extends StatefulWidget {
  ...
  //CONSTRUCTOR
  @override
  _myHomePageState createState() => new _myHomePageState(this.tipo);
}

class _myHomePageState extends State<homePages> {
  _myHomePageState(this.tipo);
  String tipo;
  var url =
        ...
        builder: (context, orientation) {
          return GridView.count(
            ...
            children: pokeHub.pokemon
                .where((poke) => (
                //BUSQUEDA POR TIPO
                poke.type.toList().toList().toString().toLowerCase().contains(this.tipo.toLowerCase())
